...
METADATA_IMG_PROPERTIES = "img_properties"
...
METADATA_ITEM_EIGHT = "Original Image Properties (Image Only)"
...
STRING_RECOVERY_SUCCESS_MSG = "[+] OPERATION SUCCESS: Original String Payload: {}"
